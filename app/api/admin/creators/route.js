...
export async function POST(request) {
  try {
    ...
    const creator = await queryOne(
      `INSERT INTO creators (name, slug, specialty, title, bio, avatar, rating, reviews,
      ...
      [name, slug, specialty, title, bio, avatar, rating, reviews, courses_count, students_count,
        is_featured, is_top_creator, sort_order, is_active, social_youtube, social_instagram, social_telegram, creator_type]
    )
